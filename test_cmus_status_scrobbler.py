"""
This script tests concurrent invocations of the scrobbler.
"""
import os
import subprocess
import unittest
...
def run_scrobbler():
	subprocess.run([
	    ...
	    'status', 'playing', 'file', '/home/user/Music/song1.mp3', 'artist',
	    'Artist A', 'album', 'Album X', 'title', 'Song 1', 'duration', '240'
	])
